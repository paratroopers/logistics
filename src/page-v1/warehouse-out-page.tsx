...
interface WarehouseOutPageStates {
    /** 数据源*/
...
@withRouter
class WarehouseOutPage extends React.Component<WarehouseOutPageProps, WarehouseOutPageStates> {
...
export default Form.create<any>()(WarehouseOutPage);