...
export class WarehousePackageApprovePage extends React.Component<WarehousePackageApprovePageProps, WarehousePackageApprovePageStates> {
    ...
    render() {
        ...
        return <Layout className="warehouse-package-approve-page view-content-page">
            <Layout.Header className="warehouse-package-approve-page-header view-content-page-header">
