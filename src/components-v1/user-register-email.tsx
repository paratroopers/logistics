...
interface UserRegisterEmailProps extends FormComponentProps {
    onClickCode?: React.FormEventHandler<any>;
    /** 验证账号是否已经存在*/
    validatorAccount?: (value:string,callback) => void;
}

interface UserRegisterEmailStates {
    /** 验证码禁用倒计时*/
    countDown: number;
    /** 验证密码*/
...
class UserRegisterEmail extends Component<UserRegisterEmailProps, UserRegisterEmailStates> {
...
export default Form.create<any>()(UserRegisterEmail);